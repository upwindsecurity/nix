...
in
{
  ...
  config = mkIf cfg.enable {
    environment.etc."upwind/agent.yaml".text = ''
      ...
      region: "${cfg.region}"
      api-host: "https://sensor${if cfg.region == "eu" then ".eu" else ""}.${cfg.domain}" # Derived from script logic
      auth-endpoint: "https://oauth${if cfg.region == "eu" then ".eu" else ""}.${cfg.domain}/oauth/token" # Derived
    ...
    environment.etc."upwind/agent-hostconfig.yaml".text = ''
      ...
      region: "${cfg.region}"
      api-host: "https://sensor${if cfg.region == "eu" then ".eu" else ""}.${cfg.domain}"
