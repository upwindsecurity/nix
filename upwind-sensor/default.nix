...
in
{
  ...
  config = mkIf cfg.enable {
    environment.etc."upwind/agent.yaml".text = ''
      ...
      region: "${cfg.region}"
      api-host: "https://sensor${if cfg.region == "eu" then ".eu" else ""}.${domain}" # Derived from script logic
      auth-endpoint: "https://oauth${if cfg.region == "eu" then ".eu" else ""}.${domain}/oauth/token" # Derived
    ...
    environment.etc."upwind/sensor-hostconfig.yaml".text = ''
      ...
      region: "${cfg.region}"
      api-host: "https://sensor${if cfg.region == "eu" then ".eu" else ""}.${domain}"
